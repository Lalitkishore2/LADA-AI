...
- Code: `.agents/skills/lada-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/lada-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
