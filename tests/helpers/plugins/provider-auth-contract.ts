...
type LoginOpenAICodexOAuth =
  (typeof import("lada/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("lada/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("lada/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("lada/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("lada/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("lada/plugin-sdk/provider-auth-login")>(
    "lada/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("lada/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("lada/plugin-sdk/provider-auth")>(
    "lada/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
