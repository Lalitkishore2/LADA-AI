...
function resolveSignalMaxBytes(cfg: LADAConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: LADAConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
