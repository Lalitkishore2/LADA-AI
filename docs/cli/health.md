---
summary: "CLI reference for `lada health` (gateway health snapshot via RPC)"
read_when:
...
- Default `lada health` asks the running gateway for its health snapshot. When the
