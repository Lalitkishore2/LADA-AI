---
summary: "Messaging platforms LADA can connect to"
read_when:
  - You want to choose a chat channel for LADA
...
LADA can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [WeChat](https://www.npmjs.com/package/@tencent-weixin/lada-weixin) — Tencent iLink Bot plugin via QR login; private chats only.
...
- Channels can run simultaneously; configure multiple and LADA will route per chat.
