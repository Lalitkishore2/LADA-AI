---
summary: "Use SOUL.md to give your LADA agent an actual voice instead of generic assistant sludge"
read_when:
...
LADA injects it on normal sessions, so it has real weight. If your agent
...
For LADA, `SOUL.md` is that layer.
...
Path fixed for LADA workspaces: use `SOUL.md`, not `http://SOUL.md`.
