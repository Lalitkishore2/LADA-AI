---
summary: "LADA tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools LADA provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    LADA), others are **external** (published on npm by the community).
...
These tools ship with LADA and are available without installing any plugins:
...
| `group:lada`   | All built-in LADA tools (excludes plugin tools)                                                       |
