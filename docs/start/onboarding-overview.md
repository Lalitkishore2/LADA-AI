---
summary: "Overview of LADA onboarding options and flows"
read_when:
...
LADA has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `lada onboard`                     | Launch the app            |
...
CLI command docs: [`lada onboard`](/cli/onboard)

## macOS app onboarding

Open the LADA app. The first-run wizard walks you through the same steps
