---
summary: "First-run setup flow for LADA (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give LADA">
...
<Step title="CLI">
  ...
  The app can install the global `lada` CLI via npm, pnpm, or bun.
