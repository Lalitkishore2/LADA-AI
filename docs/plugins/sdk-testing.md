...
summary: "Testing utilities and patterns for LADA plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for LADA
plugins.
...
**Import:** `lada/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "lada/plugin-sdk/testing";
...
import type { PluginRuntime } from "lada/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `lada/plugin-sdk` root barrel is rejected
...
LADA uses Vitest with V8 coverage thresholds. For plugin tests:
