---
summary: "Use Qianfan's unified API to access many models in LADA"
read_when:
...
3. LADA installed on your system
...
4. Copy the API key for use with LADA

## CLI setup

```bash
lada onboard --auth-choice qianfan-api-key
```
...
- [LADA Configuration](/gateway/configuration)
