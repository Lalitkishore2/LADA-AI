---
summary: "Use NVIDIA's OpenAI-compatible API in LADA"
read_when:
  - You want to use open models in LADA for free
...
lada onboard --auth-choice skip
lada models set nvidia/nvidia/nemotron-3-super-120b-a12b
```
