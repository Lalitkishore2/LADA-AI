...
read_when:
  - You want to use Arcee AI with LADA
...
lada onboard --auth-choice arceeai-api-key

# Via OpenRouter
lada onboard --auth-choice arceeai-openrouter
```
...
LADA currently ships this bundled Arcee catalog:
