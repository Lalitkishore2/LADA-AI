---
summary: "Use Z.AI (GLM models) with LADA"
read_when:
  - You want Z.AI / GLM models in LADA
...
for authentication. Create your API key in the Z.AI console. LADA uses the `zai` provider
with a Z.AI API key.
...
LADA currently seeds the bundled `zai` provider with:
