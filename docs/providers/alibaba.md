...
summary: "Alibaba Model Studio Wan video generation in LADA"
read_when:
  - You want to use Alibaba Wan video generation in LADA
  - You need Model Studio or DashScope API key setup for video generation
---

# Alibaba Model Studio

LADA ships a bundled `alibaba` video-generation provider for Wan models on
