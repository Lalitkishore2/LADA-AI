---
summary: "Use Xiaomi MiMo models with LADA"
read_when:
  - You want Xiaomi MiMo models in LADA
...
Xiaomi MiMo is the API platform for **MiMo** models. LADA uses the Xiaomi
...
```bash
lada onboard --auth-choice xiaomi-api-key
# or non-interactive
lada onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
