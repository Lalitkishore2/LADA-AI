---
title: "fal"
summary: "fal image and video generation setup in LADA"
read_when:
  - You want to use fal image generation in LADA
...
LADA ships a bundled `fal` provider for hosted image and video generation.
...
```bash
lada onboard --auth-choice fal-api-key
```
