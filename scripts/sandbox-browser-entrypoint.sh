...
export DISPLAY=:1
export HOME=/tmp/lada-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${LADA_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${LADA_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${LADA_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${LADA_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${LADA_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${LADA_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${LADA_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${LADA_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${LADA_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${LADA_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${LADA_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
