...
function printUsage(): void {
  console.log(`LADA CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: lada.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "lada-cli-bench-"));
