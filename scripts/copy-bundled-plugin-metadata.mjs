...
export function copyBundledPluginMetadata(params = {}) {
  ...
  for (const dirent of fs.readdirSync(extensionsRoot, { withFileTypes: true })) {
    ...
    const distManifestPath = path.join(distPluginDir, "lada.plugin.json");
    ...
    if (packageJson.lada && "extensions" in packageJson.lada) {
      packageJson.lada = {
        ...packageJson.lada,
        extensions: rewritePackageExtensions(packageJson.lada.extensions),
        ...(typeof packageJson.lada.setupEntry === "string"
          ? { setupEntry: rewritePackageEntry(packageJson.lada.setupEntry) }
          : {}),
      };
    }
