...
const DEFAULT_ANTHROPIC_MODEL = "lada-opus-4-6";
...
const ENV_PROVIDER = "LADA_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "LADA_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "LADA_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "LADA_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "LADA_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "LADA_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "LADA_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "LADA_CONTROL_UI_I18N_PROMPT_TIMEOUT";
