...
show_usage() {
    cat << EOF
clawlog - LADA Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View LADA logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    LADA logs flow through the macOS unified log (subsystem: ai.lada).
