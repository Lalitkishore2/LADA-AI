...
const env = {
  ...process.env,
  LADA_LIVE_TEST: process.env.LADA_LIVE_TEST || "1",
  LADA_LIVE_TEST_QUIET: quietOverride ?? process.env.LADA_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.LADA_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
