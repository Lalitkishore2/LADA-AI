...
# Output:
# - dist/LADA.app
# - dist/LADA-<version>.zip
# - dist/LADA-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.lada.mac}"
...
ZIP="$ROOT_DIR/dist/LADA-$VERSION.zip"
DMG="$ROOT_DIR/dist/LADA-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/LADA-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/LADA-$VERSION.dSYM.zip"
