...
export const OPTIONAL_BUNDLED_BUILD_ENV = "LADA_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.lada?.install?.npmSpec === "string" &&
    packageJson.lada.install.npmSpec.trim().length > 0
  );
}
