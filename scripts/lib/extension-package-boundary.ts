...
export const EXTENSION_PACKAGE_BOUNDARY_BASE_PATHS = {
  "lada/extension-api": ["../src/extensionAPI.ts"],
  "lada/plugin-sdk": ["../dist/plugin-sdk/src/plugin-sdk/index.d.ts"],
  "lada/plugin-sdk/*": ["../dist/plugin-sdk/src/plugin-sdk/*.d.ts"],
  "lada/plugin-sdk/account-id": ["../dist/plugin-sdk/src/plugin-sdk/account-id.d.ts"],
  "lada/plugin-sdk/channel-entry-contract": [
    "../packages/plugin-sdk/dist/src/plugin-sdk/channel-entry-contract.d.ts",
  ],
  "lada/plugin-sdk/browser-maintenance": [
    "../packages/plugin-sdk/dist/extensions/browser/browser-maintenance.d.ts",
  ],
  "lada/plugin-sdk/browser-config-runtime": [
    "../dist/plugin-sdk/src/plugin-sdk/browser-config-runtime.d.ts",
  ],
  "lada/plugin-sdk/browser-node-runtime": [
    "../dist/plugin-sdk/src/plugin-sdk/browser-node-runtime.d.ts",
  ],
  "lada/plugin-sdk/browser-setup-tools": [
    "../dist/plugin-sdk/src/plugin-sdk/browser-setup-tools.d.ts",
  ],
  "lada/plugin-sdk/browser-security-runtime": [
    "../dist/plugin-sdk/src/plugin-sdk/browser-security-runtime.d.ts",
  ],
  "lada/plugin-sdk/channel-secret-basic-runtime": [
    "../packages/plugin-sdk/dist/src/plugin-sdk/channel-secret-basic-runtime.d.ts",
  ],
  "lada/plugin-sdk/channel-secret-runtime": [
    "../dist/plugin-sdk/src/plugin-sdk/channel-secret-runtime.d.ts",
  ],
  "lada/plugin-sdk/channel-secret-tts-runtime": [
    "../packages/plugin-sdk/dist/src/plugin-sdk/channel-secret-tts-runtime.d.ts",
  ],
  "lada/plugin-sdk/channel-streaming": [
    "../dist/plugin-sdk/src/plugin-sdk/channel-streaming.d.ts",
  ],
  "lada/plugin-sdk/error-runtime": ["../dist/plugin-sdk/src/plugin-sdk/error-runtime.d.ts"],
  "lada/plugin-sdk/provider-catalog-shared": [
    "../packages/plugin-sdk/dist/src/plugin-sdk/provider-catalog-shared.d.ts",
  ],
  "lada/plugin-sdk/provider-entry": [
    "../packages/plugin-sdk/dist/src/plugin-sdk/provider-entry.d.ts",
  ],
  "lada/plugin-sdk/secret-ref-runtime": [
    "../dist/plugin-sdk/src/plugin-sdk/secret-ref-runtime.d.ts",
  ],
  "lada/plugin-sdk/ssrf-runtime": ["../dist/plugin-sdk/src/plugin-sdk/ssrf-runtime.d.ts"],
  "@lada/*.js": ["../packages/plugin-sdk/dist/extensions/*.d.ts", "../extensions/*"],
  "@lada/*": ["../packages/plugin-sdk/dist/extensions/*", "../extensions/*"],
  "@lada/plugin-sdk/*": ["../dist/plugin-sdk/src/plugin-sdk/*.d.ts"],
} as const;
...
export const EXTENSION_PACKAGE_BOUNDARY_XAI_PATHS = {
  ...prefixExtensionPackageBoundaryPaths(
    (({
      "lada/plugin-sdk/channel-secret-basic-runtime": _omitBasic,
      "lada/plugin-sdk/channel-secret-tts-runtime": _omitTts,
      ...rest
  ...
  "lada/plugin-sdk/cli-runtime": ["../../dist/plugin-sdk/src/plugin-sdk/cli-runtime.d.ts"],
  "lada/plugin-sdk/provider-catalog-shared": [
    "../../dist/plugin-sdk/src/plugin-sdk/provider-catalog-shared.d.ts",
  ],
  "lada/plugin-sdk/provider-env-vars": [
    "../../dist/plugin-sdk/src/plugin-sdk/provider-env-vars.d.ts",
  ],
  "lada/plugin-sdk/provider-entry": [
    "../../dist/plugin-sdk/src/plugin-sdk/provider-entry.d.ts",
  ],
  "lada/plugin-sdk/provider-web-search-contract": [
    "../../dist/plugin-sdk/src/plugin-sdk/provider-web-search-contract.d.ts",
  ],
  "@lada/*.js": ["../../packages/plugin-sdk/dist/extensions/*.d.ts", "../*"],
  "@lada/*": ["../*"],
  "@lada/plugin-sdk/*": ["../../dist/plugin-sdk/src/plugin-sdk/*.d.ts"],
  "@lada/anthropic-vertex/api.js": ["./.boundary-stubs/anthropic-vertex-api.d.ts"],
  "@lada/ollama/api.js": ["./.boundary-stubs/ollama-api.d.ts"],
  "@lada/ollama/runtime-api.js": ["./.boundary-stubs/ollama-runtime-api.d.ts"],
  "@lada/speech-core/runtime-api.js": ["./.boundary-stubs/speech-core-runtime-api.d.ts"],
} as const;
