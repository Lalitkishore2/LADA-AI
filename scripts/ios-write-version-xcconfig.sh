...
- LADA_GATEWAY_VERSION = exact package.json version
- LADA_MARKETING_VERSION = short iOS/App Store version
- LADA_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
LADA_GATEWAY_VERSION = ${PACKAGE_VERSION}
LADA_MARKETING_VERSION = ${MARKETING_VERSION}
LADA_BUILD_VERSION = ${BUILD_NUMBER}
EOF
