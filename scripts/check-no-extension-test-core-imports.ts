...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']lada\/plugin-sdk["']/,
    hint: "Use lada/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']lada\/plugin-sdk\/test-utils["']/,
    hint: "Use lada/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']lada\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or lada/plugin-sdk/testing for public surfaces.",
  },
  {
