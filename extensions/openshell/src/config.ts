...
import { buildPluginConfigSchema, type LADAPluginConfigSchema } from "lada/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): LADAPluginConfigSchema {
