...
import { mediaKindFromMime } from "lada/plugin-sdk/media-runtime";
import { withTempDownloadPath } from "lada/plugin-sdk/temp-path";
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "lada-feishu-resource-",
