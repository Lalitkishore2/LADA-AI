...
function getScopedFeishuConfig(cfg: LADAConfig, accountId: string): ScopedFeishuConfig {
...
function isFeishuConfigured(cfg: LADAConfig, accountId?: string | null): boolean {
