...
import { hasConfiguredSecretInput } from "lada/plugin-sdk/setup";
import { asRecord, hasNonEmptyString } from "./comment-shared.js";

function isFeishuDocToolEnabled(cfg: LADAConfig): boolean {
...
export function collectFeishuSecurityAuditFindings(params: { cfg: LADAConfig }) {
