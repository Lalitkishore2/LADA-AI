...
import { createAccountStatusSink } from "lada/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "lada/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "lada/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "lada/plugin-sdk/conversation-runtime";
import { buildPassiveProbedChannelStatusSummary } from "lada/plugin-sdk/extension-shared";
...
function resolveZalouserOutboundChunkMode(cfg: LADAConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: LADAConfig, accountId?: string) {
