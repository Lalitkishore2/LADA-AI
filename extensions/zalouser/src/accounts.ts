...
function mergeZalouserAccountConfig(cfg: LADAConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: LADAConfig; accountId?: string | null }) {
