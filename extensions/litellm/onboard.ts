...
export const LITELLM_DEFAULT_MODEL_ID = "lada-opus-4-6";
...
export function applyLitellmProviderConfig(cfg: LADAConfig): LADAConfig {
  return litellmPresetAppliers.applyProviderConfig(cfg);
}

export function applyLitellmConfig(cfg: LADAConfig): LADAConfig {
