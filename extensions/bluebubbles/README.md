...
This package contains the **BlueBubbles external channel plugin** for LADA.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `lada/plugin-sdk` helpers.
