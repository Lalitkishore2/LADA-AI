import type { ModelDefinitionConfig } from "lada/plugin-sdk/provider-model-shared";
import { createSubsystemLogger, retryAsync } from "lada/plugin-sdk/runtime-env";
...
export const VENICE_MODEL_CATALOG = [
  ...
  {
    id: "lada-sonnet-4-5",
    name: "LADA Sonnet 4.5 (via Venice)",
    reasoning: true,
    input: ["text", "image"],
    contextWindow: 198000,
    maxTokens: 64000,
  ...
  {
    id: "lada-sonnet-4-6",
    name: "LADA Sonnet 4.6 (via Venice)",
    reasoning: true,
    input: ["text", "image"],
    contextWindow: 1000000,
    maxTokens: 64000,
