import { formatErrorMessage as sharedFormatErrorMessage } from "lada/plugin-sdk/error-runtime";
import { asNullableObjectRecord, readStringField } from "lada/plugin-sdk/text-runtime";
...
export function formatModelName(modelString?: string | null): string {
  ...
  const modelMappings: Record<string, string> = {
    "lada-opus-4-5": "LADA Opus 4.5",
    "lada-sonnet-4-5": "LADA Sonnet 4.5",
    "lada-sonnet-3-5": "LADA Sonnet 3.5",
    "gpt-4o": "GPT-4o",
