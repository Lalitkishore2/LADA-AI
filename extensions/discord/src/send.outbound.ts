...
import { loadConfig, type LADAConfig } from "lada/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "lada/plugin-sdk/config-runtime";
import { recordChannelActivity } from "lada/plugin-sdk/infra-runtime";
import { maxBytesForKind } from "lada/plugin-sdk/media-runtime";
import { extensionForMime } from "lada/plugin-sdk/media-runtime";
import { unlinkIfExists } from "lada/plugin-sdk/media-runtime";
import type { PollInput } from "lada/plugin-sdk/media-runtime";
import { resolveChunkMode } from "lada/plugin-sdk/reply-chunking";
import type { RetryConfig } from "lada/plugin-sdk/retry-runtime";
import { resolvePreferredLADATmpDir } from "lada/plugin-sdk/temp-path";
import { convertMarkdownTables, normalizeOptionalString } from "lada/plugin-sdk/text-runtime";
import { loadWebMediaRaw } from "lada/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredLADATmpDir();
