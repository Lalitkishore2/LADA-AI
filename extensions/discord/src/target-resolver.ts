import type { DirectoryConfigParams } from "lada/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "lada/plugin-sdk/messaging-targets";
