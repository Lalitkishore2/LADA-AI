...
import type { LADAConfig, ReplyToMode } from "lada/plugin-sdk/config-runtime";
import { loadConfig } from "lada/plugin-sdk/config-runtime";
import { createConnectedChannelStatusPatch } from "lada/plugin-sdk/gateway-runtime";
import { getPluginCommandSpecs } from "lada/plugin-sdk/plugin-runtime";
import { resolveTextChunkLimit } from "lada/plugin-sdk/reply-chunking";
import {
  danger,
  isVerbose,
  logVerbose,
...
} from "lada/plugin-sdk/runtime-group-policy";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("lada/plugin-sdk/reply-history").HistoryEntry[]
    >();
