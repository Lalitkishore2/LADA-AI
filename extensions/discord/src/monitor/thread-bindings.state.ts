...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "lada/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("lada.discordThreadBindingsState");
