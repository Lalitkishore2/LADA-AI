...
import { formatAllowlistMatchMeta } from "lada/plugin-sdk/allow-from";
import {
  buildMentionRegexes,
...
import { resolveControlCommandGate } from "lada/plugin-sdk/command-auth-native";
import { hasControlCommand } from "lada/plugin-sdk/command-detection";
import { shouldHandleTextCommands } from "lada/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "lada/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "lada/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "lada/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "lada/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "lada/plugin-sdk/runtime-env";
import { logDebug } from "lada/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("lada/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("lada/plugin-sdk/conversation-binding-runtime");
