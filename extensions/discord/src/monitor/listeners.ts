...
type LoadedConfig = ReturnType<typeof import("lada/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("lada/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("lada/plugin-sdk/runtime-env").createSubsystemLogger>;
