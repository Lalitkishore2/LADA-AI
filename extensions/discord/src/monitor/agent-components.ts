...
import { resolveHumanDelayConfig } from "lada/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "lada/plugin-sdk/channel-inbound";
import { isDangerousNameMatchingEnabled } from "lada/plugin-sdk/dangerous-name-runtime";
import { resolveMarkdownTableMode } from "lada/plugin-sdk/markdown-table-runtime";
import { getAgentScopedMediaLocalRoots } from "lada/plugin-sdk/media-runtime";
import { createNonExitingRuntime, logVerbose } from "lada/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "lada/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "lada/plugin-sdk/text-runtime";
...
let replyRuntimePromise: Promise<typeof import("lada/plugin-sdk/reply-runtime")> | undefined;
let replyPipelineRuntimePromise:
  | Promise<typeof import("lada/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function _loadReplyRuntime() {
  replyRuntimePromise ??= import("lada/plugin-sdk/reply-runtime");
  return await replyRuntimePromise;
}
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("lada/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__lada_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__lada_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__lada_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__lada_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__lada_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__lada_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "LADA form";
  customId = "__lada_discord_component_modal_wildcard__";
  components = [];
