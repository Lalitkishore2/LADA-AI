...
import { AcpRuntimeError } from "lada/plugin-sdk/acp-runtime";
...
let runtimeEnvModule: typeof import("lada/plugin-sdk/runtime-env");
...
function createConfigWithDiscordAccount(overrides: Record<string, unknown> = {}): LADAConfig {
  return {
    channels: {
      discord: {
        accounts: {
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("lada/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("lada/plugin-sdk/runtime-env");
