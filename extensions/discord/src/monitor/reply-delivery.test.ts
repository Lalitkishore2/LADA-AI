...
vi.mock("lada/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("lada/plugin-sdk/retry-runtime")>(
    "lada/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
