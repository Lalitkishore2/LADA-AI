...
import { resolveCommandAuthorizedFromAuthorizers } from "lada/plugin-sdk/command-auth-native";
import type { DiscordAccountConfig, LADAConfig } from "lada/plugin-sdk/config-runtime";
...
import { logError } from "lada/plugin-sdk/text-runtime";
import {
