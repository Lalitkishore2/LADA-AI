...
import type { SessionBindingRecord } from "lada/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "lada/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "lada/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("lada/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("lada/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("lada/plugin-sdk/config-runtime").LADAConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
