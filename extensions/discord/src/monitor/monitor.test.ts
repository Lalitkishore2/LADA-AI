...
import { buildPluginBindingApprovalCustomId } from "lada/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/lada-sessions-test.json");
