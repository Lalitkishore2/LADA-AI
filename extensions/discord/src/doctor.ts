...
import { collectProviderDangerousNameMatchingScopes } from "lada/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: LADAConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: LADAConfig,
  doctorFixCommand: string,
): { config: LADAConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: LADAConfig): string[] {
