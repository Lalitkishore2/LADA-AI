import type { LADAPluginApi } from "lada/plugin-sdk/core";
...
function resolveThreadBindingFlags(api: LADAPluginApi, accountId?: string) {
...
export function registerDiscordSubagentHooks(api: LADAPluginApi) {
