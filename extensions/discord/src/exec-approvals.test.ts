...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<LADAConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<LADAConfig["channels"]>["discord"]>>,
): LADAConfig {
  return {
    channels: {
      discord: {
