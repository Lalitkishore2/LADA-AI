...
} from "lada/plugin-sdk/allowlist-config-edit";
import { createScopedDmSecurityResolver } from "lada/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "lada/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "lada/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "lada/plugin-sdk/channel-pairing";
import { createOpenProviderConfiguredRouteWarningCollector } from "lada/plugin-sdk/channel-policy";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "lada/plugin-sdk/directory-runtime";
import { formatErrorMessage } from "lada/plugin-sdk/error-runtime";
import { createLazyRuntimeModule } from "lada/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "lada/plugin-sdk/outbound-runtime";
import { sleepWithAbort } from "lada/plugin-sdk/runtime-env";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "lada/plugin-sdk/status-helpers";
import { resolveTargetsWithOptionalToken } from "lada/plugin-sdk/target-resolver-runtime";
...
function resolveDiscordStartupDelayMs(cfg: LADAConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). LADA adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
