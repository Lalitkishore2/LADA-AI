...
import { createSubsystemLogger } from "lada/plugin-sdk/core";
import { formatErrorMessage } from "lada/plugin-sdk/error-runtime";
import { resolveAwsSdkEnvVarName } from "lada/plugin-sdk/provider-auth-runtime";
import type {
  BedrockDiscoveryConfig,
  ModelDefinitionConfig,
  ModelProviderConfig,
} from "lada/plugin-sdk/provider-model-shared";
 ...
 *   "us.anthropic.lada-sonnet-4-6" → "anthropic.lada-sonnet-4-6"
 *
 * Application profiles carry the model ARN in their models[] array:
 *   models[0].modelArn = "arn:aws:bedrock:us-east-1::foundation-model/anthropic.lada-sonnet-4-6"
 ...
 * "us.anthropic.lada-sonnet-4-6" has the same capabilities as
 * "anthropic.lada-sonnet-4-6" — including image input, reasoning support,
 * and token limits.
 *
