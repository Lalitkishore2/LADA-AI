import type { ChannelDoctorLegacyConfigRule } from "lada/plugin-sdk/channel-contract";
...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  {
    path: ["talk"],
    message:
      "talk.voiceId/talk.voiceAliases/talk.modelId/talk.outputFormat/talk.apiKey are legacy; use talk.providers.<provider> and run lada doctor --fix.",
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: LADAConfig }): {
  config: LADAConfig;
  changes: string[];
} {
