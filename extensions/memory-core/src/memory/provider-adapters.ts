...
import { resolveUserPath } from "lada/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "lada/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall LADA (this should install node-llama-cpp): npm i -g lada@latest"
      : null,
