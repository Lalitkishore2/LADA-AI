...
import type { checkQmdBinaryAvailability as checkQmdBinaryAvailabilityFn } from "lada/plugin-sdk/memory-core-host-engine-qmd";
...
vi.mock("lada/plugin-sdk/memory-core-host-engine-qmd", () => ({
...
function createQmdCfg(agentId: string): LADAConfig {
  return {
...
function createBuiltinCfg(agentId: string): LADAConfig {
  return {
    agents: {
      defaults: {
