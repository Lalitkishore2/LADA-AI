...
import { withFileLock } from "lada/plugin-sdk/file-lock";
import {
...
} from "lada/plugin-sdk/memory-core-host-engine-foundation";
import {
  buildSessionEntry,
...
function normalizeHanBm25Query(query: string): string {
  ...
  // Keep Han/CJK BM25 queries intact so LADA search semantics match direct qmd search.
  return trimmed;
}
