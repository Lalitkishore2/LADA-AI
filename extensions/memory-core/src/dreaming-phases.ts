...
import type { LADAConfig, LADAPluginApi } from "lada/plugin-sdk/memory-core";
import {
  buildSessionEntry,
  listSessionFilesForAgent,
  parseUsageCountedSessionIdFromFileName,
  sessionPathForFile,
} from "lada/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "lada/plugin-sdk/memory-core-host-runtime-files";
import {
...
} from "lada/plugin-sdk/memory-core-host-status";
...
type Logger = Pick<LADAPluginApi["logger"], "info" | "warn" | "error">;
const LIGHT_SLEEP_EVENT_TEXT = "__lada_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__lada_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- lada:dreaming:light:start -->",
    endMarker: "<!-- lada:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- lada:dreaming:rem:start -->",
    endMarker: "<!-- lada:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: LADAPluginApi): void {
