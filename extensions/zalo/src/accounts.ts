...
function mergeZaloAccountConfig(cfg: LADAConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: LADAConfig): ResolvedZaloAccount[] {
