export { getChatChannelMeta, type ChannelPlugin } from "lada/plugin-sdk/core";
...
export { normalizeE164 } from "lada/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "lada/plugin-sdk/config-runtime";
import type { LADAConfig as RuntimeLADAConfig } from "lada/plugin-sdk/config-runtime";

export { type ChannelMessageActionName } from "lada/plugin-sdk/channel-contract";
...
export type LADAConfig = RuntimeLADAConfig;
export type WhatsAppAccountConfig = NonNullable<
  NonNullable<NonNullable<RuntimeLADAConfig["channels"]>["whatsapp"]>["accounts"]
>[string];
