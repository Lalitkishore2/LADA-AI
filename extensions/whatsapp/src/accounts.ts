...
import { resolveOAuthDir } from "lada/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: LADAConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: LADAConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: LADAConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: LADAConfig): ResolvedWhatsAppAccount[] {
