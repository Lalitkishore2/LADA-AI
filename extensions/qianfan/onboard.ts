...
function resolveQianfanPreset(cfg: LADAConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: LADAConfig): LADAConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: LADAConfig): LADAConfig {
