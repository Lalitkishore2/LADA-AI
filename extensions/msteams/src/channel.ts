...
import { createTopLevelChannelConfigAdapter } from "lada/plugin-sdk/channel-config-helpers";
...
const resolveMSTeamsChannelConfig = (cfg: LADAConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: LADAConfig }>(
