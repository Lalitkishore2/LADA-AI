...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "lada/plugin-sdk/msteams";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { resolvePreferredLADATmpDir } from "../../../src/infra/tmp-lada-dir.js";
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredLADATmpDir(), "msteams-mention-"));
