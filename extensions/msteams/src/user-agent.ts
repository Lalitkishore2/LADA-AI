...
function resolveLADAVersion(): string {
  try {
 ...
 * and appends the LADA version.
 *
 * Format: "teams.ts[apps]/<sdk-version> LADA/<lada-version>"
 * Example: "teams.ts[apps]/2.0.5 LADA/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} LADA/${resolveLADAVersion()}`;
  return cachedUserAgent;
}
