...
vi.mock("lada/plugin-sdk/msteams", () => ({
...
vi.mock("lada/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("lada/plugin-sdk/text-runtime")>();
  return {
    ...actual,
