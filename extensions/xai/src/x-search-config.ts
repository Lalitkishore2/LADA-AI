...
export function resolveLegacyXSearchConfig(config?: LADAConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: LADAConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: LADAConfig): JsonRecord | undefined {
