import type { ProviderRuntimeModel } from "lada/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-lada-session-id": "session-123",
        "x-lada-turn-id": "turn-123",
        "x-lada-turn-attempt": "2",
      },
      metadata: {
        lada_session_id: "session-123",
        lada_turn_id: "turn-123",
        lada_turn_attempt: "2",
        lada_transport: "websocket",
      },
    });
  });
