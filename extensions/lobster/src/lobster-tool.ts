...
import type { LADAPluginApi } from "../runtime-api.js";
import {
...
type BoundTaskFlow = ReturnType<
  NonNullable<LADAPluginApi["runtime"]>["taskFlow"]["bindSession"]
>;
...
export function createLobsterTool(api: LADAPluginApi, options?: LobsterToolOptions) {
