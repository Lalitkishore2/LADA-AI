...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<LADAConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<LADAConfig["channels"]>["slack"]>>,
): LADAConfig {
  return {
    channels: {
      slack: {
