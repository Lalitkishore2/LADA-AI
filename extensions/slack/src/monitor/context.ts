...
import type { SessionScope } from "lada/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "lada/plugin-sdk/config-runtime";
import { createDedupeCache } from "lada/plugin-sdk/core";
import type { HistoryEntry } from "lada/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("lada/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
