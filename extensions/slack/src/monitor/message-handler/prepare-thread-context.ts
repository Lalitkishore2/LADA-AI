import { formatInboundEnvelope } from "lada/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "lada/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("lada/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
