...
export function resolveTavilySearchConfig(cfg?: LADAConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: LADAConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: LADAConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
