...
import { __testing as sessionBindingTesting } from "lada/plugin-sdk/conversation-runtime";
...
type AgentBinding = NonNullable<LADAConfig["bindings"]>[number];
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    ...
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "lada-line-context-"));
