...
vi.mock("lada/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("lada/plugin-sdk/channel-pairing", () => ({
...
vi.mock("lada/plugin-sdk/command-auth", () => ({
...
vi.mock("lada/plugin-sdk/config-runtime", () => ({
...
vi.mock("lada/plugin-sdk/group-access", () => ({
...
vi.mock("lada/plugin-sdk/reply-history", () => ({
...
vi.mock("lada/plugin-sdk/routing", () => ({
