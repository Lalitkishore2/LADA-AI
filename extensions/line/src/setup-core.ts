import type { ChannelSetupAdapter, LADAConfig } from "lada/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "lada/plugin-sdk/setup";
...
export function isLineConfigured(cfg: LADAConfig, accountId: string): boolean {
