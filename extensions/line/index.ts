...
type RegisteredLineCardCommand = Parameters<LADAPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: LADAPluginApi): Promise<RegisteredLineCardCommand> {
