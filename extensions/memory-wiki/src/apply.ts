...
const GENERATED_START = "<!-- lada:wiki:generated:start -->";
const GENERATED_END = "<!-- lada:wiki:generated:end -->";
const HUMAN_START = "<!-- lada:human:start -->";
const HUMAN_END = "<!-- lada:human:end -->";
