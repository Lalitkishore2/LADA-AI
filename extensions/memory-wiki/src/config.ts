...
import { buildPluginConfigSchema, z, type LADAPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: LADAPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".lada", "wiki", "main");
}
