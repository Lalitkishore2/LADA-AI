...
export function listQQBotAccountIds(cfg: LADAConfig): string[] {
...
export function resolveDefaultQQBotAccountId(cfg: LADAConfig): string {
  const qqbot = cfg.channels?.qqbot as QQBotChannelConfig | undefined;
...
/** Apply account config updates back into the LADA config object. */
