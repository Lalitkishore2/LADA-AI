...
Official Voice Call plugin for **LADA**.
...
Docs: `https://docs.lada.ai/plugins/voice-call`
Plugin system: `https://docs.lada.ai/plugin`

## Install (local dev)

### Option A: install via LADA (recommended)
...
- advanced webhook, streaming, and tunnel notes: `https://docs.lada.ai/plugins/voice-call`
...
`https://docs.lada.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.lada.ai/plugins/voice-call#tts-for-calls`
