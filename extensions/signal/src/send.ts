...
import { resolveOutboundAttachmentFromUrl } from "lada/plugin-sdk/media-runtime";
...
let signalConfigRuntimePromise:
  | Promise<typeof import("lada/plugin-sdk/config-runtime")>
  | undefined;

async function loadSignalConfigRuntime() {
  signalConfigRuntimePromise ??= import("lada/plugin-sdk/config-runtime");
