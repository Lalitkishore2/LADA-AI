import type { ChannelSetupAdapter } from "lada/plugin-sdk/channel-setup";
import { createSetupInputPresenceValidator } from "lada/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: LADAConfig, accountId: string) {
