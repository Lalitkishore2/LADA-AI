...
vi.mock("lada/plugin-sdk/ssrf-runtime", async () => {
  const original = (await vi.importActual("lada/plugin-sdk/ssrf-runtime")) as Record<
    string,
    unknown
  >;
...
function getDescribedActions(cfg: LADAConfig, accountId?: string): string[] {
