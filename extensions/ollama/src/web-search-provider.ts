...
import { resolveEnvApiKey } from "lada/plugin-sdk/provider-auth-runtime";
import {
...
function resolveOllamaWebSearchApiKey(config?: LADAConfig): string | undefined {
...
function resolveOllamaWebSearchBaseUrl(config?: LADAConfig): string {
...
export function createOllamaWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.lada.ai/tools/web",
    autoDetectOrder: 110,
    credentialPath: "",
