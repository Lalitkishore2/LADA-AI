...
Nostr DM channel plugin for LADA using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to LADA. It enables your bot to:
...
# Configure lada to use local relay
