...
import { normalizeSecretInputString, type SecretInput } from "lada/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: LADAConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: LADAConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: LADAConfig): string {
