...
import { resolvePreferredLADATmpDir, type LADAPluginApi } from "../api.js";
import {
...
export function registerDiffsPlugin(api: LADAPluginApi): void {
  ...
  const store = new DiffArtifactStore({
    rootDir: path.join(resolvePreferredLADATmpDir(), "lada-diffs"),
    logger: api.logger,
  });
