...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: LADAConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: LADAConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: LADAConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure LADA has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: LADAConfig; accountId?: string }) =>
