...
import { createChannelPairingChallengeIssuer } from "lada/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "lada/plugin-sdk/channel-reply-pipeline";
import { loadConfig } from "lada/plugin-sdk/config-runtime";
import {
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "lada/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "lada/plugin-sdk/config-runtime";
import {
  readChannelAllowFromStore,
  upsertChannelPairingRequest,
} from "lada/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "lada/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "lada/plugin-sdk/host-runtime";
import { waitForTransportReady } from "lada/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "lada/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "lada/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "lada/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "lada/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "lada/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "lada/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "lada/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "lada/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T lada@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., lada@192.168.64.3)
