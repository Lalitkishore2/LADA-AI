...
import type { ResolvedAgentRoute } from "lada/plugin-sdk/routing";
...
type ResolveConfiguredBindingRouteFn =
  typeof import("lada/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("lada/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/lada-sessions.json");
