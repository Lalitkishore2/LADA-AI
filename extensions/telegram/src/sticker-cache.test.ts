...
vi.mock("lada/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/lada-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.LADA_STATE_DIR = "/tmp/lada-test-sticker-cache";
    fs.rmSync("/tmp/lada-test-sticker-cache", { recursive: true, force: true });
