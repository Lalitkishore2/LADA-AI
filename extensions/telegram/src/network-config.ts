...
import { isTruthyEnvValue, isWSL2Sync } from "lada/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "lada/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "LADA_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "LADA_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "LADA_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable LADA_TELEGRAM_DNS_RESULT_ORDER
