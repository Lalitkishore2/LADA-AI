...
export function shouldShowTelegramDmAccessWarning(cfg: LADAConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`lada config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`lada config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
