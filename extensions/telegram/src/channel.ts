...
import type { ChannelMessageActionAdapter } from "lada/plugin-sdk/channel-contract";
import { clearAccountEntryFields, createChatChannelPlugin } from "lada/plugin-sdk/channel-core";
import { createPairingPrefixStripper } from "lada/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "lada/plugin-sdk/channel-policy";
...
} from "lada/plugin-sdk/outbound-runtime";
import { chunkMarkdownText } from "lada/plugin-sdk/reply-runtime";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as LADAConfig;
