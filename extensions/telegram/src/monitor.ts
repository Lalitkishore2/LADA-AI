...
import { resolveAgentMaxConcurrent } from "lada/plugin-sdk/config-runtime";
import type { LADAConfig } from "lada/plugin-sdk/config-runtime";
import { loadConfig } from "lada/plugin-sdk/config-runtime";
import { waitForAbortSignal } from "lada/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: LADAConfig): RunOptions<unknown> {
  return {
    sink: {
