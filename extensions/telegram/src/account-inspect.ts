import { resolveAccountWithDefaultFallback } from "lada/plugin-sdk/account-core";
import type { LADAConfig } from "lada/plugin-sdk/config-runtime";
import { coerceSecretRef } from "lada/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "lada/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "lada/plugin-sdk/core";
import { resolveDefaultSecretProviderAlias } from "lada/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "lada/plugin-sdk/routing";
import {
...
function inspectTokenValue(params: { cfg: LADAConfig; value: unknown }): {
  token: string;
