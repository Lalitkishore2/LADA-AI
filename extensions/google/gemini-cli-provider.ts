...
import { buildOauthProviderAuthResult } from "lada/plugin-sdk/provider-auth-result";
...
import { fetchGeminiUsage } from "lada/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: LADAPluginApi) {
