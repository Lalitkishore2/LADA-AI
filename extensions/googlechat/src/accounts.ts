...
import { safeParseJsonWithSchema, safeParseWithSchema } from "lada/plugin-sdk/extension-shared";
import { isSecretRef } from "lada/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: LADAConfig): ResolvedGoogleChatAccount[] {
