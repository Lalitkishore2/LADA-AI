...
import { optionalStringEnum, stringEnum } from "lada/plugin-sdk/channel-actions";
...
// because LADA API on Vertex AI rejects nested anyOf schemas as invalid JSON Schema.
