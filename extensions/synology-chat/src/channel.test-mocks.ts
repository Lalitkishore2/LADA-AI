...
vi.mock("lada/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("lada/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("lada/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("lada/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("lada/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("lada/plugin-sdk/webhook-ingress");
  return {
    ...actual,
