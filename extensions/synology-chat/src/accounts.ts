...
import { resolveDangerousNameMatchingEnabled } from "lada/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full LADA config object. */
function getChannelConfig(cfg: LADAConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: LADAConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.LADA_BOT_NAME ?? "LADA";
