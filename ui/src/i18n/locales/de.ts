...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.lada/lada.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von lada dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
