...
function renderMessageMeta(meta: GroupMeta | null) {
  ...
  // Model
  if (meta.model) {
    // Shorten model name: strip provider prefix if present (e.g. "anthropic/lada-3.5-sonnet" → "lada-3.5-sonnet")
...
export const SKIP_DELETE_CONFIRM_KEY = "lada:skipDeleteConfirm";
