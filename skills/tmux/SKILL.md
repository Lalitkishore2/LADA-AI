...
Control tmux sessions by sending keystrokes and reading output. Essential for managing LADA sessions.

## When to Use

✅ **USE this skill when:**

- Monitoring LADA/Codex sessions in tmux
...
For interactive TUIs (LADA, Codex, etc.), split text and Enter into separate sends to avoid paste/multiline edge cases:
