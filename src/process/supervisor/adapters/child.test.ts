...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.LADA_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.LADA_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.LADA_SERVICE_MARKER = originalServiceMarker;
    }
  });
