...
/**
 * Checks if user needs to log in with LADA.ai
 * Extracted from getTeleportErrors() in TeleportError.tsx
 * @returns true if login is required, false otherwise
 */
export async function checkNeedsLADAAiLogin(): Promise<boolean> {
 ...
 * @param repo The repository name (e.g., "lada-cli-internal")
