...
import { queryModelWithoutStreaming } from '../../services/api/lada.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .lada/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.lada', 'skills', skillName, 'SKILL.md')
