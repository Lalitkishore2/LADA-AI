...
import { trackLADAInChromeTabId } from './common.js';
export type { Tool } from '@modelcontextprotocol/sdk/types.js';

/**
 * All tool names from BROWSER_TOOLS in @ant/lada-for-chrome-mcp.
...
/**
 * Renders a clickable "View Tab" link for LADA in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a LADA in Chrome MCP tool
...
/**
 * Custom tool result message rendering for lada-in-chrome tools.
...
/**
 * Returns tool method overrides for LADA in Chrome MCP tools. Use this to customize
 * rendering for chrome tools in a single spread operation.
 */
export function getLADAInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `LADA in Chrome[${displayName}]`;
    },
