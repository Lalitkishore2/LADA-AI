...
export type Theme = {
  ...
  bashBorder: string
  lada: string
  ladaShimmer: string // Lighter version of lada color for shimmer effect
  ladaBlue_FOR_SYSTEM_SPINNER: string
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: string
  permission: string
...
const lightTheme: Theme = {
  ...
  lada: 'rgb(215,119,87)', // LADA orange
  ladaShimmer: 'rgb(245,149,117)', // Lighter lada orange for shimmer effect
  ladaBlue_FOR_SYSTEM_SPINNER: 'rgb(87,105,247)', // Medium blue for system spinner
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(117,135,255)', // Lighter blue for system spinner shimmer
  ...
  briefLabelLADA: 'rgb(215,119,87)', // Brand orange
...
const lightAnsiTheme: Theme = {
  ...
  lada: 'ansi:redBright',
  ladaShimmer: 'ansi:yellowBright',
  ladaBlue_FOR_SYSTEM_SPINNER: 'ansi:blue',
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const darkAnsiTheme: Theme = {
  ...
  lada: 'ansi:redBright',
  ladaShimmer: 'ansi:yellowBright',
  ladaBlue_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const lightDaltonizedTheme: Theme = {
  ...
  lada: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  ladaShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  ladaBlue_FOR_SYSTEM_SPINNER: 'rgb(51,102,255)', // Bright blue for system spinner
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(101,152,255)', // Lighter bright blue for system spinner shimmer
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelLADA: 'rgb(255,153,51)', // Orange adjusted for deuteranopia (matches lada)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  lada: 'rgb(215,119,87)', // LADA orange
  ladaShimmer: 'rgb(235,159,127)', // Lighter lada orange for shimmer effect
  ladaBlue_FOR_SYSTEM_SPINNER: 'rgb(147,165,255)', // Blue for system spinner
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(177,195,255)', // Lighter blue for system spinner shimmer
...
const darkDaltonizedTheme: Theme = {
  ...
  lada: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  ladaShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  ladaBlue_FOR_SYSTEM_SPINNER: 'rgb(153,204,255)', // Light blue for system spinner
  ladaBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(183,224,255)', // Lighter blue for system spinner shimmer
