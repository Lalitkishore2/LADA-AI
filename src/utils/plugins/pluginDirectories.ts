 ...
 * 2. Default: ~/.lada/plugins or ~/.lada/cowork_plugins
 */
export function getPluginsDirectory(): string {
  ...
  // like "~/.lada/plugins" becomes a literal `~` directory created in the
  ...
  return join(getLADAConfigHomeDir(), getPluginsDirectoryName())
}
