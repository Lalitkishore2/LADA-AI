...
export function getProjectsDir(): string {
  return join(getLADAConfigHomeDir(), 'projects')
}
 ...
 *
 * Streaming (lada.ts:~2024) emits one AssistantMessage per content_block_stop
...
/**
 * Append a periodic task summary for `lada ps`. Unlike ai-title this is
