...
export async function checkContextWarnings(
  ...
  const [ladaMdWarning, agentWarning, mcpWarning, unreachableRulesWarning] =
    await Promise.all([
      checkLADAMdFiles(),
