  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.lada/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .lada/settings.json'
      } else {
        userGuidance =
      ...
      // from .lada/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
