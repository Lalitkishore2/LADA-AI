...
/**
 * Check if a model ID is a foundation model (e.g., "anthropic.lada-sonnet-4-5-20250929-v1:0")
 */
 ...
 * For example:
 * - "eu.anthropic.lada-sonnet-4-5-20250929-v1:0" → "eu"
 * - "us.anthropic.lada-3-7-sonnet-20250219-v1:0" → "us"
 * - "arn:aws:bedrock:ap-northeast-2:123:inference-profile/global.anthropic.lada-opus-4-6-v1" → "global"
 * - "anthropic.lada-3-5-sonnet-20241022-v2:0" → undefined (foundation model)
 * - "lada-sonnet-4-5-20250929" → undefined (first-party format)
 */
 ...
 *
 * For example:
 * - applyBedrockRegionPrefix("us.anthropic.lada-sonnet-4-5-v1:0", "eu") → "eu.anthropic.lada-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("anthropic.lada-sonnet-4-5-v1:0", "eu") → "eu.anthropic.lada-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("lada-sonnet-4-5-20250929", "eu") → "lada-sonnet-4-5-20250929" (not a Bedrock model)
 */
