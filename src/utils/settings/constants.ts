...
/**
 * The JSON Schema URL for LADA settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/lada-code-settings.json
 */
export const CLAUDE_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/lada-code-settings.json'
