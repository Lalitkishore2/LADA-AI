 ...
 *
 * Parses `lada-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   lada-cli://open
 *   lada-cli://open?q=hello+world
 *   lada-cli://open?q=fix+tests&repo=owner/repo
 *   lada-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'lada-cli'
 ...
 * the `cd /d <cwd> && <lada.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a lada-cli:// URI into a structured action.
 *
...
/**
 * Build a lada-cli:// deep link URL.
 */
