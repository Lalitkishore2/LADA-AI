...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: LADAConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: LADAConfig, mode: ChannelAuthMode): string {
