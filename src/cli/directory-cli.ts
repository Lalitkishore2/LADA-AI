    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["lada directory self --channel slack", "Show the connected account identity."],
          [
            'lada directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["lada directory groups list --channel discord", "List available groups/channels."],
          [
            "lada directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.lada.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
