 ...
 * critique user-written rules. Dynamically imported when `lada auto-mode ...` runs.
 */
...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for LADA.\n' +
  '\n' +
  'LADA has an "auto mode" that uses an AI classifier to decide whether ' +
  ...
  if (!hasCustomRules) {
    process.stdout.write(
      'No custom auto mode rules found.\n\n' +
        ...
        'Run `lada auto-mode defaults` to see the default rules for reference.\n',
    )
    return
  }
