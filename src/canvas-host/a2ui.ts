...
export const A2UI_PATH = "/__lada__/a2ui";

export const CANVAS_HOST_PATH = "/__lada__/canvas";

export const CANVAS_WS_PATH = "/__lada__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.ladaCanvasA2UIAction.postMessage(...)
  // - Android: window.ladaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["ladaCanvasA2UIAction"];
  ...
  globalThis.LADA = globalThis.LADA ?? {};
  globalThis.LADA.postMessage = postToNode;
  globalThis.LADA.sendUserAction = sendUserAction;
  globalThis.ladaPostMessage = postToNode;
  globalThis.ladaSendUserAction = sendUserAction;
