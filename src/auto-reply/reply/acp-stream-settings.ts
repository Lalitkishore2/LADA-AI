...
function resolveAcpStreamCoalesceIdleMs(cfg: LADAConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: LADAConfig): number {
...
export function resolveAcpProjectionSettings(cfg: LADAConfig): AcpProjectionSettings {
