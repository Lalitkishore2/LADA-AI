...
function resolveMentionPatterns(cfg: LADAConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: LADAConfig | undefined, agentId?: string): RegExp[] {
