...
export type ResponsePrefixContext = {
  /** Short model name (e.g., "gpt-5.4", "lada-opus-4-6") */
  model?: string;
 ...
 * - Date suffixes (e.g., "-20260205" from "lada-opus-4-6-20260205")
 * - Common version suffixes (e.g., "-latest")
 *
 * @example
 * extractShortModelName("openai-codex/gpt-5.4") // "gpt-5.4"
 * extractShortModelName("lada-opus-4-6-20260205") // "lada-opus-4-6"
