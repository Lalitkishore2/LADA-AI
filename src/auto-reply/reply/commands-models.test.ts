...
vi.mock("../../agents/model-catalog.js", () => ({
  loadModelCatalog: vi.fn(async () => [
    { provider: "anthropic", id: "lada-opus-4-5", name: "LADA Opus" },
    { provider: "anthropic", id: "lada-sonnet-4-5", name: "LADA Sonnet" },
...
describe("handleModelsCommand", () => {
  ...
  it("handles provider pagination all mode and unknown providers", async () => {
    const cases = [
      ...
      },
      {
        ...
        includes: ["Models (anthropic", "page 1/1", "anthropic/lada-opus-4-5"],
      ...
      agents: {
        defaults: {
          model: {
            ...
            fallbacks: ["anthropic/lada-opus-4-5"],
          },
  ...
  it("threads the routed agent through /models replies", async () => {
    const scopedCfg = {
      commands: { text: true },
      agents: {
        defaults: { model: { primary: "anthropic/lada-opus-4-5" } },
