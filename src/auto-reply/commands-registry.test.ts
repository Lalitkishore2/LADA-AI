...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@lada", { botUsername: "lada" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@lada args", {
        botUsername: "lada",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "lada" })).toBe(
      "/help@otherbot",
    );
  });
