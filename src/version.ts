...
declare const __LADA_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "lada";
...
function resolveVersionFromRuntimeSources(params: {
  ...
  const preferredCandidates =
    params.preference === "env-first"
      ? [params.env["LADA_VERSION"], params.runtimeVersion]
      : [params.runtimeVersion, params.env["LADA_VERSION"]];
  return (
    firstNonEmpty(
      ...preferredCandidates,
      params.env["LADA_SERVICE_VERSION"],
...
// Single source of truth for the current LADA version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION = resolveBinaryVersion({
  moduleUrl: import.meta.url,
  injectedVersion: typeof __LADA_VERSION__ === "string" ? __LADA_VERSION__ : undefined,
  bundledVersion: process.env.LADA_BUNDLED_VERSION,
});
