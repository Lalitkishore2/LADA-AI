...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.lada.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", LADA_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.lada.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when LADA_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.lada.gateway.plist",
    },
    {
      name: "uses profile-specific label when LADA_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", LADA_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.lada.jbphoenix.plist",
    },
    {
      name: "prefers LADA_LAUNCHD_LABEL over LADA_PROFILE",
      env: {
        HOME: "/Users/test",
        LADA_PROFILE: "jbphoenix",
        LADA_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from LADA_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        LADA_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty LADA_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        LADA_PROFILE: "myprofile",
        LADA_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.lada.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
