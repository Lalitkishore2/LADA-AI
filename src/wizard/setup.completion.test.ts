...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("lada");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "lada");
