...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`lada assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `lada assistant`: count of background tasks (Agent calls, teammates,
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on lada.ai)
  ...
  // Always-on bridge: session URL on lada.ai (set when connected)
