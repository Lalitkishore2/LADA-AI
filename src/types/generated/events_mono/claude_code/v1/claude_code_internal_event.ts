...
//   protoc               unknown
// source: events_mono/lada_code/v1/lada_code_internal_event.proto
 ...
 * See lada-cli-internal/src/services/statsig.ts for the source of these fields
 */
export interface EnvironmentMetadata {
  ...
  is_lada_code_action?: boolean | undefined
  is_lada_ai_auth?: boolean | undefined
  ...
  is_lada_code_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  lada_code_container_id?: string | undefined
  lada_code_remote_session_id?: string | undefined
...
/**
 * SlackContext contains context fields present on every LADA-in-Slack (CIS) event.
 * Event-specific fields (errorType, durationMs, httpStatus, etc.) go in
 * LADACodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * LADACodeInternalEvent represents events logged from LADA via Statsig
 * This schema matches the structure in lada-cli-internal/src/services/statsig.ts
 * Source table: proj-product-data-nhme.raw_statsig_internal_tools.events
 */
export interface LADACodeInternalEvent {
  ...
  /** LADA-in-Slack context (only present for cis_* events) */
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    is_lada_code_action: false,
    is_lada_ai_auth: false,
    version: '',
    github_event_name: '',
    ...
    arch: '',
    is_lada_code_remote: false,
    remote_environment_type: '',
    lada_code_container_id: '',
    lada_code_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_lada_code_action: isSet(object.is_lada_code_action)
        ? globalThis.Boolean(object.is_lada_code_action)
        : false,
      is_lada_ai_auth: isSet(object.is_lada_ai_auth)
        ? globalThis.Boolean(object.is_lada_ai_auth)
        : false,
      ...
      is_lada_code_remote: isSet(object.is_lada_code_remote)
        ? globalThis.Boolean(object.is_lada_code_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      lada_code_container_id: isSet(object.lada_code_container_id)
        ? globalThis.String(object.lada_code_container_id)
        : '',
      lada_code_remote_session_id: isSet(object.lada_code_remote_session_id)
        ? globalThis.String(object.lada_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_lada_code_action !== undefined) {
      obj.is_lada_code_action = message.is_lada_code_action
    }
    if (message.is_lada_ai_auth !== undefined) {
      obj.is_lada_ai_auth = message.is_lada_ai_auth
    }
    ...
    if (message.is_lada_code_remote !== undefined) {
      obj.is_lada_code_remote = message.is_lada_code_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.lada_code_container_id !== undefined) {
      obj.lada_code_container_id = message.lada_code_container_id
    }
    if (message.lada_code_remote_session_id !== undefined) {
      obj.lada_code_remote_session_id = message.lada_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_lada_code_action = object.is_lada_code_action ?? false
    message.is_lada_ai_auth = object.is_lada_ai_auth ?? false
    ...
    message.is_lada_code_remote = object.is_lada_code_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.lada_code_container_id = object.lada_code_container_id ?? ''
    message.lada_code_remote_session_id =
      object.lada_code_remote_session_id ?? ''
...
function createBaseLADACodeInternalEvent(): LADACodeInternalEvent {
  return {
    event_name: '',
...
export const LADACodeInternalEvent: MessageFns<LADACodeInternalEvent> = {
  fromJSON(object: any): LADACodeInternalEvent {
    return {
  ...
  toJSON(message: LADACodeInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<LADACodeInternalEvent>, I>>(
    base?: I,
  ): LADACodeInternalEvent {
    return LADACodeInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<LADACodeInternalEvent>, I>>(
    object: I,
  ): LADACodeInternalEvent {
    const message = createBaseLADACodeInternalEvent()
