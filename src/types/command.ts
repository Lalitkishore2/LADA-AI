 ...
 *
 * Example: `availability: ['lada-ai', 'console']` shows the command to
 * lada.ai subscribers and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // lada.ai OAuth subscriber (Pro/Max/Team/Enterprise via lada.ai)
  | 'lada-ai'
  // Console API key user (direct api.anthropic.com, not via lada.ai OAuth)
  | 'console'
