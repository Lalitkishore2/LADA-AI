...
function buildNoImageGenerationModelConfiguredMessage(cfg: LADAConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: LADAConfig }) {
