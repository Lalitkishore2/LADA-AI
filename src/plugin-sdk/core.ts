...
import type { LADAPluginApi } from "../plugins/types.js";
...
export type { LADAPluginToolContext, LADAPluginToolFactory } from "../plugins/types.js";
export type {
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: LADAPluginApi) => void;
  registerFull?: (api: LADAPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: LADAConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
