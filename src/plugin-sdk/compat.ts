...
const shouldWarnCompatImport =
  ...
  process.env.LADA_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "lada/plugin-sdk/compat is deprecated for new plugins. Migrate to focused lada/plugin-sdk/<subpath> imports. See https://docs.lada.ai/plugins/sdk-migration",
    {
      code: "LADA_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.lada.ai/plugins/sdk-migration",
    },
  );
}
