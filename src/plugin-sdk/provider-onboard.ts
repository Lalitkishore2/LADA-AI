...
export type { LADAConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
const LEGACY_OPENCODE_ZEN_DEFAULT_MODELS = new Set([
  "opencode/lada-opus-4-5",
  "opencode-zen/lada-opus-4-5",
]);

export const OPENCODE_ZEN_DEFAULT_MODEL = "opencode/lada-opus-4-6";

export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: LADAConfig, ...args: TArgs) => LADAConfig;
  applyConfig: (cfg: LADAConfig, ...args: TArgs) => LADAConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: LADAConfig, preset: TParams) => LADAConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: LADAConfig): {
  next: LADAConfig;
  changed: boolean;
} {
