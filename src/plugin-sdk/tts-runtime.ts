...
type FacadeModule = typeof import("@lada/speech-core/runtime-api.js");
import {
...
export type ResolvedTtsConfig = import("@lada/speech-core/runtime-api.js").ResolvedTtsConfig;
export type ResolvedTtsModelOverrides =
  import("@lada/speech-core/runtime-api.js").ResolvedTtsModelOverrides;
export type TtsDirectiveOverrides =
  import("@lada/speech-core/runtime-api.js").TtsDirectiveOverrides;
export type TtsDirectiveParseResult =
  import("@lada/speech-core/runtime-api.js").TtsDirectiveParseResult;
export type TtsResult = import("@lada/speech-core/runtime-api.js").TtsResult;
export type TtsSynthesisResult = import("@lada/speech-core/runtime-api.js").TtsSynthesisResult;
export type TtsTelephonyResult = import("@lada/speech-core/runtime-api.js").TtsTelephonyResult;
