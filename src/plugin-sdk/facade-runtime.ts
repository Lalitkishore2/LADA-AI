...
const LADA_SOURCE_EXTENSIONS_ROOT = path.resolve(LADA_PACKAGE_ROOT, "extensions");
...
function resolveSourceFirstPublicSurfacePath(params: {
  ...
  const sourceRoot = params.bundledPluginsDir ?? path.resolve(LADA_PACKAGE_ROOT, "extensions");
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: LADA_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
