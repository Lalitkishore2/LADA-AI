...
export const DESCRIPTION = 'Get or set LADA configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set LADA configuration settings.

  View or change LADA settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.lada.json)
${globalSettings.join('\n')}
