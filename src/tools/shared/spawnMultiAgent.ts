 ...
 * When outside tmux: Creates a lada-swarm session with all teammates in a tiled layout.
 */
async function handleSpawnSplitPane(
  ...
  // - Outside both: creates lada-swarm session with tiled teammates
  ...
  // Build the command to spawn LADA with teammate identity
...
/**
 * Handle spawn operation - creates a new LADA instance.
