...
export type AgentDefaultsConfig = {
  ...
  /** Optional CLI backends for text-only fallback (lada-cli, etc.). */
...
export type AgentCompactionConfig = {
  ...
  /** Optional model override for compaction summarization (e.g. "openrouter/anthropic/lada-sonnet-4-6").
