...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): LADAConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: LADAConfig, env: NodeJS.ProcessEnv) =>
