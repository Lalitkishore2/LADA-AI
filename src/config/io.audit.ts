...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.LADA_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.LADA_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.LADA_WATCH_COMMAND),
