...
let runtimeConfigSnapshot: LADAConfig | null = null;
let runtimeConfigSourceSnapshot: LADAConfig | null = null;
...
export function getRuntimeConfigSnapshot(): LADAConfig | null {
  return runtimeConfigSnapshot;
}

export function getRuntimeConfigSourceSnapshot(): LADAConfig | null {
...
export function loadPinnedRuntimeConfig(loadFresh: () => LADAConfig): LADAConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: LADAConfig;
  hadRuntimeSnapshot: boolean;
  hadBothSnapshots: boolean;
  loadFreshConfig: () => LADAConfig;
