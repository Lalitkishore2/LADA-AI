...
function resolveSpeechProviderPluginEntries(cfg?: LADAConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: LADAConfig): SpeechProviderPlugin[] {
