 ...
 *
 * @see https://github.com/lada/lada/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an LADAConfig.
 */
export function timestampOptsFromConfig(cfg: LADAConfig): TimestampInjectionOptions {
  return {
