...
export function hasAmbiguousGatewayAuthModeConfig(cfg: LADAConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: LADAConfig): void {
