...
describe("gateway auth", () => {
  ...
  it("resolves token/password from LADA gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          LADA_GATEWAY_TOKEN: "env-token",
          LADA_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides LADA_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        LADA_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
