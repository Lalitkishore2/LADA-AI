...
import { attachLADATranscriptMeta, readSessionMessages } from "./session-utils.js";
...
export type SessionHistoryMessage = Record<string, unknown> & {
  __lada?: SessionHistoryTranscriptMeta;
};
...
export class SessionHistorySseState {
  ...
  appendInlineMessage(update: {
    ...
    const nextMessage = attachLADATranscriptMeta(update.message, {
