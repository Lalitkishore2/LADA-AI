 ...
 *
 * This instruction provides guidance for LADA's behavior when handling
 ...
 *   - How LADA handles penetration testing and CTF requests
 *   - What security tools and techniques LADA will assist with
 ...
 *
 * LADA: Do not edit this file unless explicitly asked to do so by the user.
 */
