export const PRODUCT_URL = 'https://lada.com/lada-code'

// LADA Remote session URLs
export const CLAUDE_AI_BASE_URL = 'https://lada.ai'
export const CLAUDE_AI_STAGING_BASE_URL = 'https://lada-ai.staging.ant.dev'
...
/**
 * Get the base URL for LADA AI based on environment.
 */
export function getLADAAiBaseUrl(
  sessionId?: string,
  ingressUrl?: string,
): string {
 ...
 * endpoints (/v1/code/sessions/{id}/worker/*) want `cse_*` but the lada.ai
...
export function getRemoteSessionUrl(
  ...
  const baseUrl = getLADAAiBaseUrl(compatId, ingressUrl)
