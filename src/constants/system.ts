...
const DEFAULT_PREFIX = `You are LADA, Anthropic's official CLI for LADA.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are LADA, Anthropic's official CLI for LADA, running within the LADA Agent SDK.`
const AGENT_SDK_PREFIX = `You are a LADA agent, built on Anthropic's LADA Agent SDK.`
 ...
 * server verifies this token to confirm the request came from a real LADA
