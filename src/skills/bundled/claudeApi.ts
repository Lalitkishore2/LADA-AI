...
// ladaApiContent.js bundles 247KB of .md strings. Lazy-load inside
// getPromptForCommand so they only enter memory when /lada-api is invoked.
type SkillContent = typeof import('./ladaApiContent.js')
...
→ Refer to \`{lang}/lada-api/README.md\`

**Chat UI or real-time response display:**
→ Refer to \`{lang}/lada-api/README.md\` + \`{lang}/lada-api/streaming.md\`

**Long-running conversations (may exceed context window):**
→ Refer to \`{lang}/lada-api/README.md\` — see Compaction section

**Prompt caching / optimize caching / "why is my cache hit rate low":**
→ Refer to \`shared/prompt-caching.md\` + \`{lang}/lada-api/README.md\` (Prompt Caching section)

**Function calling / tool use / agents:**
→ Refer to \`{lang}/lada-api/README.md\` + \`shared/tool-use-concepts.md\` + \`{lang}/lada-api/tool-use.md\`

**Batch processing (non-latency-sensitive):**
→ Refer to \`{lang}/lada-api/README.md\` + \`{lang}/lada-api/batches.md\`

**File uploads across multiple requests:**
→ Refer to \`{lang}/lada-api/README.md\` + \`{lang}/lada-api/files-api.md\`
...
export function registerLADAApiSkill(): void {
  registerBundledSkill({
    name: 'lada-api',
    description:
      'Build apps with the LADA API or Anthropic SDK.\n' +
      'TRIGGER when: code imports `anthropic`/`@anthropic-ai/sdk`/`lada_agent_sdk`, or user asks to use LADA API, Anthropic SDKs, or Agent SDK.\n' +
      'DO NOT TRIGGER when: code imports `openai`/other AI SDK, general programming, or ML/data-science tasks.',
    allowedTools: ['Read', 'Grep', 'Glob', 'WebFetch'],
    userInvocable: true,
    async getPromptForCommand(args) {
      const content = await import('./ladaApiContent.js')
