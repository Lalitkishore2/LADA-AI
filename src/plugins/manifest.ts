...
export const PLUGIN_MANIFEST_FILENAME = "lada.plugin.json";
...
export type PluginManifestModelSupport = {
   ...
   * from shorthand model refs such as `gpt-5.4` or `lada-sonnet-4.6`.
   */
...
// package.json "lada" metadata (used for setup/catalog)
...
export type LADAPackageStartup = {
  /**
...
export type LADAPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: LADAPackageStartup;
};
