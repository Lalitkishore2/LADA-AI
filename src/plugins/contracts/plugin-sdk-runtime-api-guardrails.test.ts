...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile("imessage", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type LADAConfig } from "lada/plugin-sdk/core";',
    ...
    'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "lada/plugin-sdk/status-helpers";',
    ...
    'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiLADAConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
  ],
  [bundledPluginFile("googlechat", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID } from "lada/plugin-sdk/account-id";',
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "lada/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "lada/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "lada/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "lada/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "lada/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "lada/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "lada/plugin-sdk/channel-status";',
    'export { chunkTextForOutbound } from "lada/plugin-sdk/text-chunking";',
    'export type { LADAConfig } from "lada/plugin-sdk/config-runtime";',
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "lada/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "lada/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "lada/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "lada/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile("matrix", "runtime-api.ts")]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "lada/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, LADAConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "lada/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "lada/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile("nextcloud-talk", "runtime-api.ts")]: [
    'export * from "lada/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile("telegram", "runtime-api.ts")]: [
    ...
    'export type { LADAPluginService, LADAPluginServiceContext, PluginLogger } from "lada/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "lada/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "lada/plugin-sdk/acp-runtime";',
    'export { clearAccountEntryFields, emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "lada/plugin-sdk/core";',
    ...
    'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "lada/plugin-sdk/channel-status";',
    'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "lada/plugin-sdk/channel-actions";',
    ...
    'export type { LADAConfig } from "lada/plugin-sdk/config-runtime";',
    'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeLADAConfig["channels"]>["telegram"] >;',
