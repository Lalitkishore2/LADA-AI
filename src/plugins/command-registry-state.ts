...
import type { LADAPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = LADAPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("lada.pluginCommandsState");
