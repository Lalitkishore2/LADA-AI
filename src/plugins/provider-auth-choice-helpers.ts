...
export function applyProviderAuthConfigPatch(cfg: LADAConfig, patch: unknown): LADAConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<LADAConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: LADAConfig, model: string): LADAConfig {
