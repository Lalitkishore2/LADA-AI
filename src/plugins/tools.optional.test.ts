...
function expectLoaderCall(overrides: Record<string, unknown>) {
  expect(loadLADAPluginsMock).toHaveBeenCalledWith(expect.objectContaining(overrides));
}
