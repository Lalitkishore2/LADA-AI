...
export function applyGoogleGeminiModelDefault(cfg: LADAConfig): {
  next: LADAConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: LADAConfig): LADAConfig {
...
export function applyOpenAIConfig(cfg: LADAConfig): LADAConfig {
...
export function applyOpencodeGoModelDefault(cfg: LADAConfig): {
  next: LADAConfig;
  changed: boolean;
} {
