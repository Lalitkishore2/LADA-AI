...
import type { PluginConfigUiHint, LADAPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: LADAPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): LADAPluginConfigSchema {
  return {
