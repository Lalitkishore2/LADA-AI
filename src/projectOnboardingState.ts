...
export function getSteps(): Step[] {
  const hasLADAMd = getFsImplementation().existsSync(
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask LADA to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'ladamd',
      text: 'Run /init to create a CLAUDE.md file with instructions for LADA',
      isComplete: hasLADAMd,
      isCompletable: true,
      isEnabled: !isWorkspaceDirEmpty,
    },
  ]
