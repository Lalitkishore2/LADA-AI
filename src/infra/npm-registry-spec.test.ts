...
describe("npm registry spec validation", () => {
  it.each([
    "@lada/voice-call",
    "@lada/voice-call@1.2.3",
    "@lada/voice-call@1.2.3-beta.4",
    "@lada/voice-call@latest",
    "@lada/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/lada/lada",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@lada/voice-call@1.2.3-beta.1",
      expected: {
        name: "@lada/voice-call",
        raw: "@lada/voice-call@1.2.3-beta.1",
  ...
  it.each([
    {
      spec: "@lada/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@lada/voice-call@beta"`,
    },
    {
      spec: "@lada/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
