...
import { openClawRootFs, openClawRootFsSync } from "./lada-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["lada"]);
...
export async function resolveLADAPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveLADAPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
