...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): LADAConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): LADAConfig {
  return {
