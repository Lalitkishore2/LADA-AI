  ...
  return withEnvAsync(
    {
      ...
      LADA_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when LADA_VERSION is not set", async () => {
  ...
  it("prefers LADA_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over LADA_SERVICE_VERSION when LADA_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        LADA_VERSION: " ",
        LADA_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when LADA_VERSION and LADA_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        LADA_VERSION: " ",
        LADA_SERVICE_VERSION: "\t",
