...
export function listChannelMessageActions(cfg: LADAConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: LADAConfig): ChannelMessageCapability[] {
