...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: LADAConfig) => string[];
  resolveAccount: (cfg: LADAConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: LADAConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: LADAConfig) => string;
  setAccountEnabled?: (params: {
    cfg: LADAConfig;
    accountId: string;
    enabled: boolean;
  }) => LADAConfig;
  deleteAccount?: (params: { cfg: LADAConfig; accountId: string }) => LADAConfig;
  isEnabled?: BivariantCallback<(account: ResolvedAccount, cfg: LADAConfig) => boolean>;
  disabledReason?: BivariantCallback<(account: ResolvedAccount, cfg: LADAConfig) => string>;
  isConfigured?: BivariantCallback<
    (account: ResolvedAccount, cfg: LADAConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: BivariantCallback<(account: ResolvedAccount, cfg: LADAConfig) => string>;
  describeAccount?: BivariantCallback<
    (account: ResolvedAccount, cfg: LADAConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: LADAConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: LADAConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: BivariantCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: LADAConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.lada.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: LADAConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: LADAConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: LADAConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: LADAConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: LADAConfig; accountId?: string | null }) =>
    | {
