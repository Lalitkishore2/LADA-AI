...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: LADAConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: LADAConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: LADAConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: LADAConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: LADAConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: LADAConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: LADAConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: LADAConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: LADAConfig) => LADAConfig;
