...
import type { LADAPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, LADAPackageManifest>>;

const ENV_CATALOG_PATHS = ["LADA_PLUGIN_CATALOG_PATHS", "LADA_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<LADAPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
