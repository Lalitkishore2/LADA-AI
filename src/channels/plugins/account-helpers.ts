...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: LADAConfig): string | undefined {
  ...
  function listAccountIds(cfg: LADAConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: LADAConfig): string {
