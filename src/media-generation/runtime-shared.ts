...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: LADAConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: LADAConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: LADAConfig;
  agentDir?: string;
  listProviders: (cfg?: LADAConfig) => CapabilityProviderCandidate[];
}): string[] {
