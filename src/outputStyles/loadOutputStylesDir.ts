...
/**
 * Loads markdown files from .lada/output-styles directories throughout the project
 * and from ~/.lada/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .lada/output-styles/*.md -> project styles
 * - User ~/.lada/output-styles/*.md -> user styles (overridden by project styles)
 *
