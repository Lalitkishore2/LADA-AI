...
export function useUnseenDivider(messageCount: number): {
  ...
  const onScrollAway = useCallback((handle: ScrollBoxHandle) => {
    ...
    //   at max (Sarah Deaton, #lada-code-feedback 2026-03-15)
 ...
 * users think of as "a new message from LADA" — not raw assistant entries
 ...
 * until LADA's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what LADA was
