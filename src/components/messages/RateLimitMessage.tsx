...
import { getRateLimitTier, getSubscriptionType, isLADAAISubscriber } from 'src/utils/auth.js';
...
export function RateLimitMessage(t0) {
  ...
  const isMax20x = rateLimitTier === "default_lada_max_20x";
  let t3;
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = shouldProcessMockLimits() || isLADAAISubscriber();
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  ...
  const isCurrentlyRateLimited = ladaAiLimits.status === "rejected" && ladaAiLimits.resetsAt !== undefined && !ladaAiLimits.isUsingOverage;
  ...
  bb0: {
    ...
    if ($[7] !== shouldAutoOpenRateLimitOptionsMenu) {
      t7 = getUpsellMessage({
        ...
        isTeamOrEnterprise,
        hasBillingAccess: hasLADAAiBillingAccess()
      });
