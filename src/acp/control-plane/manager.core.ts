...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: LADAConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: LADAConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: LADAConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: LADAConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: LADAConfig }): Promise<void> {
