...
export function isAcpEnabledByPolicy(cfg: LADAConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: LADAConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: LADAConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: LADAConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: LADAConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: LADAConfig, agentId: string): boolean {
