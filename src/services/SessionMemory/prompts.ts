...
Based on the user conversation above (EXCLUDING this note-taking instruction message as well as system prompt, lada.md entries, or any past session summaries), update the session notes file.
 ...
 * Custom prompts can be placed at ~/.lada/session-memory/prompt.md
