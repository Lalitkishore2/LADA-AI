 ...
 * Initialized during LADA startup.
 */
 ...
 * asynchronously during LADA startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during LADA startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/lada-code/issues/15521:
 ...
 *
 * This should be called during LADA shutdown. Stops all running LSP servers
