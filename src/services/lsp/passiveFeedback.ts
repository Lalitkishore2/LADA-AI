...
/**
 * Map LSP severity to LADA diagnostic severity
 *
 * Maps LSP severity numbers to LADA diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to LADA diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by LADA's attachment system.
 */
 ...
 * from all LSP servers and routes them to LADA's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to LADA format (can throw on invalid URIs)
