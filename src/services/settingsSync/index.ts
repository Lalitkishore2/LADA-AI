 ...
 *
 * Syncs user settings and memory files across LADA environments.
 *
...
import { clearMemoryFileCaches } from '../../utils/ladamd.js'
...
function getSettingsSyncEndpoint(): string {
  return `${getOauthConfig().BASE_API_URL}/api/lada_code/user_settings`
}
