...
/**
 * Full response from GET /api/lada_code/user_settings
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.lada/settings.json',
  USER_MEMORY: '~/.lada/CLAUDE.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.lada/settings.local.json`,
