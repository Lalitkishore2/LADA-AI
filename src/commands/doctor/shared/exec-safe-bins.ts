...
function collectExecSafeBinScopes(cfg: LADAConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: LADAConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: LADAConfig): {
  config: LADAConfig;
  changes: string[];
  warnings: string[];
} {
