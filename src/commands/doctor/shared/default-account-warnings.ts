...
export function collectMissingDefaultAccountBindingWarnings(cfg: LADAConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: LADAConfig): string[] {
  const warnings: string[] = [];
