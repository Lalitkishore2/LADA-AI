...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://lada.local")).toBe("https://lada.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://lada.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: lada security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://lada.local" },
      ...
      { Item: "Security", Value: "Run: lada security audit --deep" },
