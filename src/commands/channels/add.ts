...
import { replaceConfigFile, type LADAConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: LADAConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as LADAConfig;
  ...
  // May trigger loadLADAPlugins on cache miss (disk scan + jiti import)
