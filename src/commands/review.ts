...
// user triggers, so the description carries "LADA on the web" + URL.
const CCR_TERMS_URL = 'https://code.lada.com/docs/en/lada-code-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in LADA on the web. See ${CCR_TERMS_URL}`,
