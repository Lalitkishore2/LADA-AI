...
import { clearMemoryFileCaches, getMemoryFiles } from '../../utils/ladamd.js';
...
function MemoryCommand({
  ...
  const handleSelectMemoryFile = async (memoryPath: string) => {
    try {
      // Create lada directory if it doesn't exist (idempotent with recursive)
      if (memoryPath.includes(getLADAConfigHomeDir())) {
        await mkdir(getLADAConfigHomeDir(), {
          recursive: true
        });
      }
  ...
  return <Dialog title="Memory" onCancel={handleCancel} color="remember">
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          <Text dimColor>
            Learn more: <Link url="https://code.lada.com/docs/en/memory" />
          </Text>
        </Box>
      </Box>
    </Dialog>;
