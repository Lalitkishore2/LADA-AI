...
vi.mock("./onboard-non-interactive/local/auth-choice.plugin-providers.js", async () => {
  ...
  const cloudflareAiGatewayChoice: ChoiceHandler = {
    ...
    runNonInteractive: async (ctx) => {
      ...
      return providerApiKeyAuthRuntime.applyPrimaryModel(
        withProfile,
        "cloudflare-ai-gateway/lada-sonnet-4-5",
      );
    },
  };
  ...
  const choiceMap = new Map<string, ChoiceHandler>([
    ...
    [
      ...
      createApiKeyChoice({
        ...
        defaultModel: "vercel-ai-gateway/anthropic/lada-opus-4.6",
      }),
    ],
    [
      "openai-api-key",
    ...
    [
      ...
      createApiKeyChoice({
        ...
        defaultModel: "opencode/lada-opus-4-6",
      }),
    ],
    [
      "vllm",
    ...
    [
      ...
      createApiKeyChoice({
        ...
        defaultModel: "litellm/lada-opus-4-6",
      }),
    ],
...
async function withOnboardEnv(
  ...
  const configPath = path.join(tempHome, "lada.json");
  ...
  try {
    await withEnvAsync(
      {
        HOME: tempHome,
        LADA_STATE_DIR: tempHome,
        LADA_CONFIG_PATH: configPath,
        LADA_SKIP_CHANNELS: "1",
        LADA_SKIP_GMAIL_WATCHER: "1",
        LADA_SKIP_CRON: "1",
        LADA_SKIP_CANVAS_HOST: "1",
        LADA_GATEWAY_TOKEN: undefined,
        LADA_GATEWAY_PASSWORD: undefined,
        CUSTOM_API_KEY: undefined,
        LADA_DISABLE_CONFIG_CACHE: "1",
        LADA_DISABLE_PLUGIN_DISCOVERY_CACHE: "1",
...
describe("onboard (non-interactive): provider auth", () => {
  ...
  it("stores MiniMax API key in the global auth profile", async () => {
    await withOnboardEnv("lada-onboard-minimax-", async (env) => {
  ...
  it("supports MiniMax CN API endpoint auth choice", async () => {
    await withOnboardEnv("lada-onboard-minimax-cn-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("stores Z.AI API key after probing the global endpoint", async () => {
    await withZaiProbeFetch(
      ...
      async (fetchMock) =>
        await withOnboardEnv("lada-onboard-zai-", async (env) => {
          const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("supports Z.AI CN coding endpoint auth choice", async () => {
    await withZaiProbeFetch(
      ...
      async (fetchMock) =>
        await withOnboardEnv("lada-onboard-zai-cn-", async (env) => {
          const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("supports Z.AI Coding Plan global endpoint detection", async () => {
    await withZaiProbeFetch(
      ...
      async (fetchMock) =>
        await withOnboardEnv("lada-onboard-zai-coding-global-", async (env) => {
          const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("stores xAI API key in the default auth profile", async () => {
    await withOnboardEnv("lada-onboard-xai-", async (env) => {
  ...
  it("infers Mistral auth choice from --mistral-api-key", async () => {
    await withOnboardEnv("lada-onboard-mistral-infer-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("stores Volcano Engine API key and sets default model", async () => {
    await withOnboardEnv("lada-onboard-volcengine-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("infers BytePlus auth choice from --byteplus-api-key and sets default model", async () => {
    await withOnboardEnv("lada-onboard-byteplus-infer-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("stores Vercel AI Gateway API key and sets default model", async () => {
    await withOnboardEnv("lada-onboard-ai-gateway-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
      ...
      expect(cfg.agents?.defaults?.model?.primary).toBe(
        "vercel-ai-gateway/anthropic/lada-opus-4.6",
      );
      await expectApiKeyProfile({
  ...
  it("stores legacy Anthropic setup-token onboarding again when explicitly selected", async () => {
    await withOnboardEnv("lada-onboard-token-", async ({ configPath, runtime }) => {
      ...
      expect(cfg.agents?.defaults?.model?.primary).toBe("anthropic/lada-sonnet-4-6");
  ...
  it("stores OpenAI API key and sets OpenAI default model", async () => {
    await withOnboardEnv("lada-onboard-openai-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it.each([
    {
      name: "anthropic",
      prefix: "lada-onboard-ref-flag-anthropic-",
      authChoice: "apiKey",
      optionKey: "anthropicApiKey",
      flagName: "--anthropic-api-key",
      envVar: "ANTHROPIC_API_KEY",
    ...
    {
      name: "openai",
      prefix: "lada-onboard-ref-flag-openai-",
      authChoice: "openai-api-key",
      optionKey: "openaiApiKey",
      flagName: "--openai-api-key",
      envVar: "OPENAI_API_KEY",
    ...
    {
      name: "openrouter",
      prefix: "lada-onboard-ref-flag-openrouter-",
    ...
    {
      name: "xai",
      prefix: "lada-onboard-ref-flag-xai-",
      authChoice: "xai-api-key",
      optionKey: "xaiApiKey",
      flagName: "--xai-api-key",
      envVar: "XAI_API_KEY",
    ...
    {
      name: "volcengine",
      prefix: "lada-onboard-ref-flag-volcengine-",
      authChoice: "volcengine-api-key",
      optionKey: "volcengineApiKey",
      flagName: "--volcengine-api-key",
      envVar: "VOLCANO_ENGINE_API_KEY",
    ...
    {
      name: "byteplus",
      prefix: "lada-onboard-ref-flag-byteplus-",
  ...
  it("stores the detected env alias as keyRef for both OpenCode runtime providers", async () => {
    await withOnboardEnv("lada-onboard-ref-opencode-alias-", async ({ runtime }) => {
      await withEnvAsync(
        {
  ...
  it("configures vLLM via the provider plugin in non-interactive mode", async () => {
    await withOnboardEnv("lada-onboard-vllm-non-interactive-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
        authChoice: "vllm",
  ...
  it("configures SGLang via the provider plugin in non-interactive mode", async () => {
    await withOnboardEnv("lada-onboard-sglang-non-interactive-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
        authChoice: "sglang",
  ...
  it("stores LiteLLM API key in the default auth profile", async () => {
    await withOnboardEnv("lada-onboard-litellm-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it.each([
    {
      ...
      prefix: "lada-onboard-cf-gateway-",
      options: {
    ...
    },
    {
      ...
      prefix: "lada-onboard-cf-gateway-infer-",
      options: {},
    },
    ...
    await withOnboardEnv(prefix, async ({ configPath, runtime }) => {
      ...
      expect(cfg.agents?.defaults?.model?.primary).toBe("cloudflare-ai-gateway/lada-sonnet-4-5");
      await expectApiKeyProfile({
        profileId: "cloudflare-ai-gateway:default",
        provider: "cloudflare-ai-gateway",
  ...
  it("infers Together auth choice from --together-api-key and sets default model", async () => {
    await withOnboardEnv("lada-onboard-together-infer-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("infers QIANFAN auth choice from --qianfan-api-key and sets default model", async () => {
    await withOnboardEnv("lada-onboard-qianfan-infer-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("infers Qwen auth choice from --modelstudio-api-key and sets default model", async () => {
    await withOnboardEnv("lada-onboard-modelstudio-infer-", async (env) => {
      const cfg = await runOnboardingAndReadConfig(env, {
  ...
  it("configures a custom provider from non-interactive flags", async () => {
    await withOnboardEnv("lada-onboard-custom-provider-", async ({ configPath, runtime }) => {
      await runNonInteractiveSetupWithDefaults(runtime, {
        authChoice: "custom-api-key",
  ...
  it("infers custom provider auth choice from custom flags", async () => {
    await withOnboardEnv(
      "lada-onboard-custom-provider-infer-",
  ...
  it("uses CUSTOM_API_KEY env fallback for non-interactive custom provider auth", async () => {
    await withOnboardEnv(
      "lada-onboard-custom-provider-env-fallback-",
      async ({ configPath, runtime }) => {
  ...
  it("stores CUSTOM_API_KEY env ref for non-interactive custom provider auth in ref mode", async () => {
    await withOnboardEnv(
      "lada-onboard-custom-provider-env-ref-",
      async ({ configPath, runtime }) => {
        process.env.CUSTOM_API_KEY = "custom-env-key"; // pragma: allowlist secret
        await runCustomLocalNonInteractive(runtime, {
          secretInputMode: "ref", // pragma: allowlist secret
  ...
  it("fails fast for custom provider ref mode when --custom-api-key is set but CUSTOM_API_KEY env is missing", async () => {
    await withOnboardEnv("lada-onboard-custom-provider-ref-flag-", async ({ runtime }) => {
  ...
  it("uses matching profile fallback for non-interactive custom provider auth", async () => {
    await withOnboardEnv(
      "lada-onboard-custom-provider-profile-fallback-",
      async ({ configPath, runtime }) => {
        upsertAuthProfile({
  ...
  it("fails custom provider auth when compatibility is invalid", async () => {
    await withOnboardEnv(
      "lada-onboard-custom-provider-invalid-compat-",
      async ({ runtime }) => {
        await expect(
  ...
  it("fails custom provider auth when explicit provider id is invalid", async () => {
    await withOnboardEnv("lada-onboard-custom-provider-invalid-id-", async ({ runtime }) => {
      await expect(
        runNonInteractiveSetupWithDefaults(runtime, {
          authChoice: "custom-api-key",
          customBaseUrl: "https://models.custom.local/v1",
  ...
  it("fails inferred custom auth when required flags are incomplete", async () => {
    await withOnboardEnv(
      "lada-onboard-custom-provider-missing-required-",
      async ({ runtime }) => {
        await expect(
          runNonInteractiveSetupWithDefaults(runtime, {
            customApiKey: "custom-test-key", // pragma: allowlist secret
