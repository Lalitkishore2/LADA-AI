...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set LADA_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `lada dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control LADA.");
  } else if (hint) {
    runtime.log(hint);
  }
}
