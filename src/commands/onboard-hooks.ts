...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.lada.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("lada hooks list")}`,
      `  ${formatCliCommand("lada hooks enable <name>")}`,
      `  ${formatCliCommand("lada hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
