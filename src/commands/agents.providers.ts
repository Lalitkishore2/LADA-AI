...
function resolveDefaultAccountId(cfg: LADAConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: LADAConfig): boolean {
...
export function summarizeBindings(cfg: LADAConfig, bindings: AgentBinding[]): string[] {
