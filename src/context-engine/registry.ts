...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("lada.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("lada.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: LADAConfig): Promise<ContextEngine> {
