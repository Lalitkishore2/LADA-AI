 ...
 *
 * Inbound messages from lada.ai are injected into the REPL via queuedCommands.
 */
    ...
    if (feature('BRIDGE_MODE')) {
      ...
      void (async () => {
        try {
          ...
          // Assistant mode: perpetual bridge session — lada.ai shows one
          ...
          // When a user message arrives from lada.ai, inject it into the REPL.
          ...
          if (outboundOnly) {
            ...
            if (cancelled) return;
            setMessages(prev_18 => [...prev_18, createBridgeStatusMessage(url, upgradeNudge ? 'Please upgrade to the latest version of the LADA mobile app to see your Remote Control sessions.' : undefined)]);
