...
const NPM_DEPRECATION_MESSAGE = 'LADA has switched from npm to native installer. Run `lada install` or see https://docs.anthropic.com/en/docs/lada-code/getting-started for more options.';
