...
import { CLAUDE_IN_CHROME_MCP_SERVER_NAME, isTrackedLADAInChromeTabId } from '../utils/ladaInChrome/common.js';
import { lazySchema } from '../utils/lazySchema.js';
import { enqueuePendingNotification } from '../utils/messageQueueManager.js';

// Schema for the prompt notification from Chrome extension (JSON-RPC 2.0 format)
const LADAInChromePromptNotificationSchema = lazySchema(() => z.object({
...
/**
 * A hook that listens for prompt notifications from the LADA for Chrome extension,
 * enqueues them as user prompts, and syncs permission mode changes to the extension.
 */
export function usePromptsFromLADAInChrome(mcpClients, toolPermissionMode) {
  const $ = _c(6);
  useRef(undefined);
  let t0;
  if ($[0] !== mcpClients) {
