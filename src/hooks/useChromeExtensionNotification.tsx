...
import { isChromeExtensionInstalled, shouldEnableLADAInChrome } from '../utils/ladaInChrome/setup.js';
...
async function _temp() {
  ...
  if (!shouldEnableLADAInChrome(chromeFlag)) {
    return null;
  }
  if (true && !isLADAAISubscriber()) {
    return {
      key: "chrome-requires-subscription",
      jsx: <Text color="error">LADA in Chrome requires a lada.ai subscription</Text>,
      priority: "immediate",
      timeoutMs: 5000
    };
  }
  ...
  if (!installed && !isRunningOnHomespace()) {
    return {
      ...
      jsx: <Text color="warning">Chrome extension not detected · https://lada.ai/chrome to install</Text>,
      priority: "immediate",
      timeoutMs: 3000
    };
  }
  if (chromeFlag === undefined) {
    return {
      key: "lada-in-chrome-default-enabled",
      text: "LADA in Chrome enabled \xB7 /chrome",
      priority: "low"
    };
  }
  return null;
