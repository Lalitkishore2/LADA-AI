...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<LADAConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<LADAConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: LADAConfig): WebSearchConfig {
