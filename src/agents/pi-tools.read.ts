...
function resolveAdaptiveReadMaxBytes(options?: LADAReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createLADAReadTool(base, {
...
export function createLADAReadTool(
  base: AnyAgentTool,
  options?: LADAReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
