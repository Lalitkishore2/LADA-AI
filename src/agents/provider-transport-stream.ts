...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "lada-openai-responses-transport",
  "openai-codex-responses": "lada-openai-responses-transport",
  "openai-completions": "lada-openai-completions-transport",
  "azure-openai-responses": "lada-azure-openai-responses-transport",
  "anthropic-messages": "lada-anthropic-messages-transport",
  "google-generative-ai": "lada-google-generative-ai-transport",
};
