...
async function resolveContext(config: LADAConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): LADAConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
