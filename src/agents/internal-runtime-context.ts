export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_LADA_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_LADA_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[LADA_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[LADA_INTERNAL_CONTEXT_END]]";
