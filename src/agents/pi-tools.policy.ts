...
export function resolveSubagentToolPolicy(cfg?: LADAConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: LADAConfig["tools"]): string[] | undefined {
