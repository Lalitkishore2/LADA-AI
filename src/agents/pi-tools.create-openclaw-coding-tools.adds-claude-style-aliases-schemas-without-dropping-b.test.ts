...
const defaultTools = createLADACodingTools({ senderIsOwner: true });

describe("createLADACodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const disabledOpenAiTools = createLADACodingTools({
    ...
    const anthropicTools = createLADACodingTools({
      config: disabledConfig,
    ...
    const allowModelsConfig: LADAConfig = {
      tools: {
        exec: {
    ...
    const allowed = createLADACodingTools({
    ...
    const denied = createLADACodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
    ...
    const oauthTools = createLADACodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
