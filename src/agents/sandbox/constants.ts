...
export const DEFAULT_SANDBOX_IMAGE = "lada-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "lada-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "lada-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "lada-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "lada-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "lada-sandbox-browser";
