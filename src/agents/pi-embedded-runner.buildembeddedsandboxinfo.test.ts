...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/lada-sandbox",
    agentWorkspaceDir: "/tmp/lada-workspace",
    workspaceAccess: "none",
    runtimeId: "lada-sbx-test",
    runtimeLabel: "lada-sbx-test",
    containerName: "lada-sbx-test",
    ...
    browser: {
      ...
      containerName: "lada-sbx-browser-test",
    },
