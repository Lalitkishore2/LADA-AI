...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "lada:bootstrap-context:full";

export function resolveContextInjectionMode(config?: LADAConfig): AgentContextInjection {
