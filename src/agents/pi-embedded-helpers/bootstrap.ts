...
/**
 * Strips LADA-style thought_signature fields from content blocks.
 *
 * Gemini expects thought signatures as base64-encoded bytes, but LADA stores message ids
...
export function resolveBootstrapMaxChars(cfg?: LADAConfig): number {
...
export function resolveBootstrapTotalMaxChars(cfg?: LADAConfig): number {
