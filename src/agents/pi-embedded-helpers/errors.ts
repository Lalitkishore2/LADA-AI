...
function formatDiskSpaceErrorCopy(raw: string): string | undefined {
  ...
  if (
    ...
    return (
      "LADA could not write local session data because the disk is full. " +
...
export function formatAssistantErrorText(
  ...
  opts?: { cfg?: LADAConfig; sessionKey?: string; provider?: string; model?: string },
): string | undefined {
...
export function isModelNotFoundErrorMessage(raw: string): boolean {
  ...
  // Direct pattern matches from LADA internals and common providers.
  if (
