          ...
          switch (provider) {
            ...
            case "anthropic":
              return {
                ...
                ...(modelId.includes("lada") ? { dropThinkingBlocks: true } : {}),
              };
            case "minimax":
            case "minimax-portal":
...
describe("resolveTranscriptPolicy", () => {
  ...
  it("preserves thinking blocks for newer LADA models in unowned Anthropic transport fallback", () => {
    ...
    const sonnet45 = resolveTranscriptPolicy({
      provider: "custom-anthropic-proxy",
      modelId: "lada-sonnet-4-5-20250929",
      modelApi: "anthropic-messages",
    });
