    ...
    expect(
      resolveCompactionFailureReason({
        ...
        safeguardCancelReason:
          "Compaction safeguard could not resolve an API key for anthropic/lada-opus-4-6.",
      }),
    ).toBe("Compaction safeguard could not resolve an API key for anthropic/lada-opus-4-6.");
  });
