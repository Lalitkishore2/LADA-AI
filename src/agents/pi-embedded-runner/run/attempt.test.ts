...
function createOllamaProviderConfig(injectNumCtxForOpenAICompat: boolean): LADAConfig {
  return {
    models: {
      providers: {
        ollama: {
      ...
      attempt: {
        ...
        config: {
          agents: {
            defaults: {
              compaction: {
                model: "openrouter/anthropic/lada-sonnet-4-5",
              },
            },
          },
        } as LADAConfig,
  ...
  it("includes resolved auth profile fields for context-engine afterTurn compaction", () => {
    const legacy = buildAfterTurnRuntimeContext({
      attempt: {
        ...
        agentAccountId: "acct-1",
        authProfileId: "openai:p1",
        config: { plugins: { slots: { contextEngine: "lossless-claw" } } } as LADAConfig,
        skillsSnapshot: undefined,
        senderIsOwner: true,
        provider: "openai-codex",
        modelId: "gpt-5.4",
