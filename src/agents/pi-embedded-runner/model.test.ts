...
describe("resolveModel", () => {
  ...
  it("resolves github-copilot LADA dynamic models to anthropic-messages by default", () => {
    const result = resolveModelForTest("github-copilot", "lada-sonnet-4.6", "/tmp/agent");
