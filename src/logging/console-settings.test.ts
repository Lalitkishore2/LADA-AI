...
let originalLADATestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalLADATestConsole = process.env.LADA_TEST_CONSOLE;
  process.env.LADA_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalLADATestConsole === undefined) {
    delete process.env.LADA_TEST_CONSOLE;
  } else {
    process.env.LADA_TEST_CONSOLE = originalLADATestConsole;
  }
