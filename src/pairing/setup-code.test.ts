...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("LADA_GATEWAY_TOKEN", "");
    vi.stubEnv("LADA_GATEWAY_PASSWORD", "");
    vi.stubEnv("LADA_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses LADA_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
