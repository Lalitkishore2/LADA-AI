...
function resolveResolutionLimits(config: LADAConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: LADAConfig): SecretProviderConfig {
