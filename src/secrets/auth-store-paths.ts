...
export function listAuthProfileStorePaths(config: LADAConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: LADAConfig, stateDir: string): string[] {
